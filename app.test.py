...
class BasicTestCase(unittest.TestCase):
    ...
    def test_other(self):
        tester = app.app.test_client(self)
        response = tester.get('/test', content_type="text/html")
...
class FlaskrTestCase(unittest.TestCase):
    # set up a new test database for per test
    def setUp(self):
    ...
    # destroy test db after every test
    def tearDown(self):
        os.close(self.db_fd)
    ...
    def test_register_messages(self):
        ...
        rv = self.register("cat123@test.com", "")
